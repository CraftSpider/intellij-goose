...
public class GooseLitExprImpl extends GooseExprImpl implements GooseLitExpr {

  public GooseLitExprImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public GooseLiteral getLiteral() {
    return findNotNullChildByClass(GooseLiteral.class);
  }
