...
public class GooseOnceStmtImpl extends ASTWrapperPsiElement implements GooseOnceStmt {

  public GooseOnceStmtImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull GooseVisitor visitor) {
    visitor.visitOnceStmt(this);
  }
