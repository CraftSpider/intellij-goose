...
public class GooseTypeImpl extends ASTWrapperPsiElement implements GooseType {

  public GooseTypeImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  public GooseType getType() {
    return findChildByClass(GooseType.class);
  }
